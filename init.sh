...
octadaemon add-genesis-account $(octadaemon keys show genesis -a) 7999999000000uocta,1000000000stake
...
octadaemon gentx genesis 1000000000stake --keyring-backend os --chain-id octa
